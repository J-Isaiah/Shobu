...
public record GameState(UUID gameId, TurnPhase turnPhase, Map<BoardId, Board> updatedGameBoards, Stone winner, EnumMap<BoardId, Map<Position, List<LegalMove>>> legalMovesForPlayer) {
